...
const Slider = ()=> {
    ...
    const sliders = [
        {
            url:"./foodAppImages/ss01.png"
        },
        {
            url:"./foodAppImages/ss02.png"
        },
        {
            url:"./foodAppImages/ss03.png"
        },
        {
            url:"./foodAppImages/ss04.png"
        },
    ];
    ...
    return(
        <>
            ...
            {/* <div className="max-w-[1400] h-[780px] w-full m-auto py-16 px-4 relative group"> */}
                ...
                {/* decriptions */}
                <div>
                    <h1 className="text-2xl font-bold">Namaste Food</h1>
